...
document.write(sum + "</br>" + "</br>" + "</br>");


document.write('<b>Знайти добуток усіх цілих чисел від 15 до 35:</b>'+ '</br>'+'</br>');
...
document.write('<b>Знайти середнє арифметичне всіх цілих чисел від 1 до 500:</b>'+ '</br>'+'</br>');
...
document.write(sum/num6 + "</br>" + "</br>" + "</br>");


document.write('<b>Вивести суму лише парних чисел в діапазоні від 30 до 80:</b>'+ '</br>'+'</br>');
...
if (num1 == 2 || num1 == 3 || num1 == 5 || num1 == 7) {
    ...
    document.write((num1) + " - просте число </br></br></br>");
...
if (num2 == result2) {
    document.write(`число ${num2} равняется ${num1}-ке в 2 степени` )
    }
    else if (num2 == result3) {
        document.write(`число ${num2} равняется ${num1}-ке в 3 степени` )
        }
        else if (num2 == result4) {
            document.write(`число ${num2} равняется ${num1}-ке в 4 степени` )
            }
            else if (num2 == result5) {
                document.write(`число ${num2} равняется ${num1}-ке в 5 степени` )
                }
                else if (num2 == result6) {
                    document.write(`число ${num2} равняется ${num1}-ке в 6 степени` )
                    }
                    else if (num2 == result7) {
                        document.write(`число ${num2} равняется ${num1}-ке в 7 степени` )
                        }
                        else {
